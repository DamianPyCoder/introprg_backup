...
public class VentanaCliente extends JFrame implements Runnable{
	...
	public VentanaCliente() {
		...
		etNombre.setBounds(38, 20, 240, 34);
		contentPanel.add(etNombre);
	...
	public void enviarMensajes() throws Exception{
		nombreUsuario = etNombre.getText();
		mensajeSalida = etSalida.getText();
		streamSalida.writeObject(nombreUsuario + ": " + mensajeSalida + "\n");
		streamSalida.flush();
		etSalida.setText("");
	}
