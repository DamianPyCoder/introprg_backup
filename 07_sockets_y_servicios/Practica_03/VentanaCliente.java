...
public class VentanaCliente extends JFrame implements Runnable {
    ...
    private JTextField etNombre; // Campo para el nombre del usuario
    ...
    public VentanaCliente() {
        ...
        etNombre = new JTextField(); // Crear el campo para el nombre del usuario
        etNombre.setBounds(38, 20, 240, 34); // Establecer posición y tamaño
        contentPanel.add(etNombre); // Agregar al panel
        etNombre.setColumns(10); // Establecer número de columnas
    ...
    public void enviarMensajes() throws Exception {
        String nombreUsuario = etNombre.getText(); // Obtener el nombre del usuario
        String mensajeSalida = nombreUsuario + ": " + etSalida.getText(); // Incluir el nombre del usuario en el mensaje
